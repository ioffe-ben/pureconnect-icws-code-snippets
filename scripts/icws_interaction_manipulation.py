...
# Code snippet description: the following snippet shows how to manipulate live interaction using ICWS API.
import json
import requests
...
body = {'file': 'name_of_the_wav_file_to_play.wav'}
request = requests.post(icws_cloud_authentication.baseURL + icws_cloud_authentication.json_connection_response['sessionId'] + '/interactions/' + interaction_id + '/play-wav', headers=icws_cloud_authentication.header, cookies=icws_cloud_authentication.cookie, data=json.dumps(body), verify=False)
