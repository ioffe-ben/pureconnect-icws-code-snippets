...
- generate a .csv document with [users to licenses](scripts/icws_csv_user_to_licenses.py) / [workgroups to users](scripts/icws_workgroup_to_users_list.py) / [users to workgroups](scripts/icws_user_to_workgroups_list.py) / [users to roles](scripts/icws_user_to_roles_list.py)
