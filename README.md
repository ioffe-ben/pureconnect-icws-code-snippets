...
- generate a .csv documnet of [IC users](scripts/icws_csv_ic_users.py) / [workgroups](scripts/icws_csv_workgroups.py) / [roles]() / [skills]() / [wrap-up codes & category]() / [status messages]()
